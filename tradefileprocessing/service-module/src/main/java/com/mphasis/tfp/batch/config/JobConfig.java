...
public class JobConfig {
    ...
    public ItemProcessor<Map<String, Object>, Object> transactionProcessor() {
        return item -> {
            ...
            if (errors.isEmpty()) {
                return createSuccessfulTransaction(fields, fileLoadId);
            } else {
    ...
    public ItemWriter<Object> transactionWriter() {
        return items -> {
            ...
            for (Object item : items) {
                if (item instanceof SuccessfulTransaction successTransaction) {
                    successList.add(successTransaction);
                } else if (item instanceof FailedTransaction failedTransaction) {
                    failedList.add(failedTransaction);
                }
            }
    ...
    private SuccessfulTransaction createSuccessfulTransaction(String[] fields, Long fileLoadId) {
