...
public class JobProcessing {
    ...
    private FailedTransaction createFailedTransaction(String[] fields, Long fileLoadId,
        ...
        try {
            ...
            // Determine error field from first error message
            if (!errors.isEmpty()) {
                ...
                } else if (firstError.contains("file header date")) {
                    failedTransaction.setErrorField("fileHeaderDate");
                ...
                } else if (firstError.contains("batch number")) {
                    failedTransaction.setErrorField("batchNumber");
                } else if (firstError.contains("action name")) {
                    failedTransaction.setErrorField("actionName");
                } else if (firstError.contains("do not report flag")) {
                    failedTransaction.setErrorField("doNotReportFlag");
                } else if (firstError.contains("owning portfolio")) {
                    failedTransaction.setErrorField("owningPortfolio");
                } else if (firstError.contains("transaction subtype")) {
                    failedTransaction.setErrorField("transactionSubtype");
                } else if (firstError.contains("cash effect")) {
                    failedTransaction.setErrorField("cashEffect");
                } else if (firstError.contains("old balance")) {
                    failedTransaction.setErrorField("oldBalance");
                } else if (firstError.contains("new balance")) {
                    failedTransaction.setErrorField("newBalance");
                } else if (firstError.contains("balance mismatch")) {
                    failedTransaction.setErrorField("balanceMismatch");
                } else if (firstError.contains("insufficient fields")) {
                    failedTransaction.setErrorField("fieldCount");
                } else if (firstError.contains("processing error")) {
                    failedTransaction.setErrorField("processingError");
                } else {
                    failedTransaction.setErrorField("general");
                }
            }
            ...
            log.trace("Line {}: Created FailedTransaction - TxnID: {}, ErrorField: {}, Error: {}",
                    ...
                    failedTransaction.getErrorField(),
